      ...
      <div id="tour-resumen" className="px-5 py-5 border-b border-white/10">
        ...
        >
          ...
          <div id="tour-tools" className="flex flex-col gap-3">
            <CatalogButton />
            <Link
              href="/sellers/resumen"
              className="flex items-center justify-between rounded-xl border border-brand-400/25 bg-brand-400/[0.06] px-3 py-2.5 text-sm text-white/85 hover:bg-brand-400/12 transition-colors text-left"
            >
              <span className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-brand-400" />
                Panel resumen
              </span>
              <span className="text-[11px] text-white/40">dashboard →</span>
            </Link>
            <ProfitButton />
            <Link
              href="/sellers/beneficios"
              className="flex items-center justify-between rounded-xl border border-emerald-400/20 bg-emerald-400/[0.05] px-3 py-2.5 text-sm text-white/85 hover:bg-emerald-400/10 transition-colors text-left"
            >
              <span className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-emerald-400" />
                Beneficio real
              </span>
              <span className="text-[11px] text-white/40">ventas · margen €→</span>
            </Link>
            <RealDataButton />
            <ToolboxButton />
            <HelpButton />
