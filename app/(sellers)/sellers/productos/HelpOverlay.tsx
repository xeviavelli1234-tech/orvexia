...
export default function HelpOverlay() {
  ...
  return (
    <div
      className="fixed inset-0 z-[60] bg-black/75 backdrop-blur-sm p-4 overflow-y-auto"
      onClick={() => setOpen(false)}
    >
      <div
        className="mx-auto max-w-xl rounded-2xl border border-cyan-400/20 bg-[rgba(7,8,18,0.99)] shadow-[0_30px_80px_-20px_rgba(34,211,238,0.4)] fade-in"
