        ...
        <div className="max-w-xl w-full">
          <div className="bg-white/10 backdrop-blur-xl border border-white/15 rounded-3xl shadow-[0_20px_60px_rgba(15,23,42,0.35)] px-6 sm:px-8 py-8 sm:py-10 text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <span className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold text-fg bg-bg-elevated shadow-[0_10px_30px_rgba(255,255,255,0.15)]">
                Lanzamiento: pronto
              </span>
            </div>
          </div>
