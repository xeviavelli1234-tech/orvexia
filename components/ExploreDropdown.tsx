...
const items = [
  ...
  },
  {
    ...
    href: "/guias",
    desc: "Cómo elegir el mejor electrodoméstico",
    accent: "#7C3AED",
    bg: "#F5F3FF",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        <div className="rounded-2xl bg-bg-elevated shadow-lg border border-border overflow-hidden">
          <div className="px-4 pt-3 pb-2 border-b border-border-subtle">
            <p className="text-[10px] font-bold text-fg-subtle uppercase tracking-[0.2em]">Explorar secciones</p>
          </div>
            ...
            {items.map((item) => (
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-fg-subtle leading-tight mt-0.5">{item.desc}</p>
                </div>
              </Link>
            ))}
          </div>
