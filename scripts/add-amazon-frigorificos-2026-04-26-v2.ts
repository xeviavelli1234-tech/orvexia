/**
 * Re-añade 9 frigoríficos Amazon (los que el usuario reconfirma con capturas,
 * de los 10 originales borrados en commit e784ee8). Único omitido: Nilson
 * NC185500E (no apareció en las capturas que mandó el usuario).
 *
 * Uso:
 *   npx tsx scripts/add-amazon-frigorificos-2026-04-26-v2.ts
 */
...
async function main() {
  ...
  console.log(
    `\n🎯 add-amazon-frigorificos-v2: ${inserted} insertados, ${updated} actualizados`,
  );
}
